...
namespace LCD.Components.Abstract
{
    ...
    public class Nor : BasicGate
    {
        ...
        public override void Draw(Graphics g)
        {
            ...
            g.DrawEllipse(Pens.Black,new Rectangle(w - 15 - 3, h / 2 - 3,6,6));
        ...
        public override void Clear(Graphics g)
        {
            ...
            g.DrawEllipse(pen, new Rectangle(w - 15 - 3, h / 2 - 3, 6, 6));
        ...
        public Nor(int numberOfInputs, Point location):base(numberOfInputs,location)
        {
        ...
        {
            return "Nor (" + Location.X + "," + Location.Y + ")";
        }
    }
}
