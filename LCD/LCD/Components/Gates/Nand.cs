...
namespace LCD.Components.Abstract
{
    ...
    public class Nand : BasicGate
    {
        ...
        public override void Draw(Graphics g)
        {
            ...
            g.DrawLine(Pens.Black, new Point(w - 16, h / 2 - 0), new Point(w - 1, h / 2 - 0));
            g.DrawEllipse(Pens.Black, new Rectangle(w - 19 - 3, h / 2 - 3, 6, 6));
        ...
        public override void Clear(Graphics g)
        {
            ...
            g.DrawLine(pen, new Point(w - 16, h / 2 - 0), new Point(w - 1, h / 2 - 0));
            g.DrawEllipse(pen, new Rectangle(w - 19 - 3, h / 2 - 3, 6, 6));
        ...
        public Nand(int numberOfInputs, Point location):base(numberOfInputs,location)
        {
        ...
        {
            return "Nand (" + Location.X + "," + Location.Y + ")";
        }
    }
}
