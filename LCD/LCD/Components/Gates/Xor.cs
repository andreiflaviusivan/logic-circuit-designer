...
namespace LCD.Components.Abstract
{
    ...
    public class Xor : BasicGate
    {
        ...
        public override void Clear(Graphics g)
        {
            ...
            g.DrawLine(pen, new Point(w - 18, h / 2 - 0), new Point(w - 1, h / 2 - 0));
        ...
        public Xor(int numberOfInputs, Point location):base(numberOfInputs,location)
        {
